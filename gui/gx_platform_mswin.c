...
void gx_gui_create_window_and_surface(gx_MicroAmpUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_MicroAmpUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_MicroAmpUI *ui) {
	...
	UnregisterClass(TEXT("gx_MicroAmpUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_MicroAmpUI *ui = (gx_MicroAmpUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
